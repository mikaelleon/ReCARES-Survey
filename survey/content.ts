...
export const SCREENING_FIELDS = [
  {
    ...
    hint: 'Perimeter-adjacent phases unlock the extended security tier. Placeholder list — confirm the real phases with the HOA.',
  },
  ...
  { id: 'sex', label: 'Sex', type: 'radio' as const, options: ['Female', 'Male'] },
  {
    id: 'age_range',
    label: 'Age range',
    type: 'select' as const,
